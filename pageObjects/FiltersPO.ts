...
class FiltersPO {
    ...
    private Checkbox = (title)=> `label[title="${title}"]`;
    ...
    private arrivalReturnRadioButton = 'label[data-testid="resultPage-departureArrivalFilter-arrival1-radio"]';
    private goSliderButtonMin = 'div[data-testid="resultPage-departureArrivalFilter-departure0-slider"] div[data-testid="handle-0"]';
    ...
    private returnSliderButtonMax = 'div[data-testid="resultPage-departureArrivalFilter-departure1-slider"] div[data-testid="handle-1"]';
    ...
    async clickAirlinesCheckbox(title): Promise<FiltersPO> {
        await this.page.click(this.Checkbox(title));
        return this;
    }
    ...
    async slideFilters(slider: SlidersEnum, xOffset: number, yOffset: number): Promise<FiltersPO> {
